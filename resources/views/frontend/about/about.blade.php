...
@section('content')
   <!-- Hero / Banner -->
  <section class="bg-[var(--brand-light)] py-20 mt-[30px]">
    <div class="container mx-auto px-6 text-center">
      <h1 class="text-xl sm:text-3xl font-extrabold gradient-text">
        About Pictoora
      </h1>
      <p class="mt-4 text-xl text-[#374151] max-w-2xl mx-auto">
  ...
  <section class="container mx-auto px-6 py-16 flex flex-col md:flex-row items-center gap-12">
    ...
    <div class="md:w-1/2 space-y-6 text-[var(--brand-gray-dark)]">
